...
- [ ] 1. Agregar método `delete` al módulo API
...
- [ ] 2. Actualizar DashboardPage.test.jsx
...
- [ ] 3. Actualizar MetricasTab.test.jsx
...
- [ ] 4. Actualizar AdminPage.test.jsx
...
- [ ] 5. Actualizar RrppFormModal.test.jsx
